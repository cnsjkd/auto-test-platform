...
P0_CASE_DEFINITIONS: list[dict[str, Any]] = [
    ...
    {
        "slug": "open-notification",
        "name": "[P0 Smoke] 打开通知栏安全动作",
        "description": "执行 open_notification，验证基础安全真机动作可用。",
        "steps": [{"action": "open_notification", "timeoutSec": 10}],
    },
    {
        "slug": "open-quick-settings",
        "name": "[P0 Smoke] 打开快捷设置安全动作",
        "description": "执行 open_quick_settings，验证基础安全真机动作可用。",
        "steps": [{"action": "open_quick_settings", "timeoutSec": 10}],
    },
    {
        "slug": "keyevent-back",
        "name": "[P0 Smoke] BACK 键安全动作",
        "description": "执行 keyevent BACK，验证基础安全真机动作可用。",
        "steps": [{"action": "keyevent", "params": {"key": "BACK"}, "timeoutSec": 10}],
    },
    {
